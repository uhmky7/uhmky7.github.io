...
<figure>
  <img src="{{ '/my_collections/assets/images/mm-layout-archive.png' | relative_url }}" alt="archive layout example">
...
![archive taxonomy layout example]({{ "/my_collections/assets/images/mm-layout-archive-taxonomy.png" | relative_url }})
...
<figure>
  <img src="{{ '/my_collections/assets/images/mm-home-post-pagination-example.jpg' | relative_url }}" alt="paginated home page example">
...
header:
  overlay_image: /my_collections/assets/images/unsplash-image-1.jpg
  caption: "Photo credit: [**Unsplash**](https://unsplash.com)"
  actions:
    - label: "More Info"
...
![single layout header overlay example]({{ "/my_collections/assets/images/mm-single-header-overlay-example.jpg" | relative_url }})

You also have the option of specifying a solid background-color to use instead of an image.

![single layout header overlay with background fill]({{ "/my_collections/assets/images/mm-single-header-overlay-fill-example.jpg" | relative_url }})
...
![transparent black overlay]({{ "/my_collections/assets/images/mm-header-overlay-black-filter.jpg" | relative_url }})
...
![transparent red overlay]({{ "/my_collections/assets/images/mm-header-overlay-red-filter.jpg" | relative_url }})
...
![Reddit link in author profile with color]({{ "/my_collections/assets/images/mm-author-profile-reddit-color.png" | relative_url }})
...
<figure>
  <img src="{{ '/my_collections/assets/images/mm-custom-sidebar-example.jpg' | relative_url }}" alt="custom sidebar content example">
...
<figure>
  <img src="{{ '/my_collections/assets/images/mm-custom-sidebar-nav.jpg' | relative_url }}" alt="sidebar navigation example">
...
![Reddit social share link button]({{ "/my_collections/assets/images/mm-social-share-links-reddit-color.png" | relative_url }})
