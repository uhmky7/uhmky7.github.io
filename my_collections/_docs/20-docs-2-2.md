...
<figure>
  <img src="{{ '/my_collections/assets/images/paragraph-indent.png' | relative_url }}" alt="screen shot of paragraphs with default indent style set">
...
<figure>
  <img src="{{ '/my_collections/assets/images/paragraph-no-indent.png' | relative_url }}" alt="screen shot of paragraphs with indent style disabled">
